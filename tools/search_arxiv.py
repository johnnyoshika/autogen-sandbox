...
def search_arxiv(query: str, max_results: int = 10) -> List[Dict[str, Any]]:
    ...
    Returns:
        List[Dict[str, Any]]: A list of dictionaries. Each dictionary contains fields such as 'title', 'authors', 'summary', and 'pdf_url'
    ...
    key = hashlib.md5(("search_arxiv(" + str(max_results) +
